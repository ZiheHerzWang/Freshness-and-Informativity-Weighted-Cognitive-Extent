...
api_key = "neYWuyKcuK3NvV4DIEwdY6IhXUcybdGz5t6GRI1Y"  
...
def process_papers(csv_file_path, start_year, end_year):
    ...
    return results
def main():
    csv_file_path = rf"new.csv"  
    start_year = 2015
    end_year = 2020
    
    results = process_papers(csv_file_path, start_year, end_year)
    with open('output_results.csv', 'a', newline='', encoding='utf-8') as csvfile:  # Add encoding='utf-8' here
